...
const PAGESPEED_SERVER_LIGHTHOUSE_REPORT = PAGESPEED_SERVER_URL + 'lighthousereport/';
...
exports.getPageSpeedReport = function(pwa) {
  return getReport(PAGESPEED_SERVER_PAGESPEED_REPORT + pwa.id + '?limit=1');
};
...
exports.getWebPageTestReport = function(pwa) {
  return getReport(PAGESPEED_SERVER_WEBPAGETEST_REPORT + pwa.id + '?limit=1');
};
...
exports.getLighthouseReport = function(pwa) {
  return getReport(PAGESPEED_SERVER_LIGHTHOUSE_REPORT + pwa.id + '?limit=1');
};
