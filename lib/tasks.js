...
const E_SAVING_TAKS = exports.E_SAVING_TAKS = 1;
const E_GET_TAKS_POP = exports.E_GET_TAKS_POP = 2;
const E_DELETE_TAKS_POP = exports.E_DELETE_TAKS_POP = 3;
      ...
      .then(result => {
        ...
        db.delete(ENTITY_NAME, task.id)
          .then(_ => {
            ...
            console.log(err);
            return reject(E_DELETE_TAKS_POP);
          });
      })
      .catch(_ => {
        return reject(E_GET_TAKS_POP);
      });
  });
};
